...
function ExecutionViewer({ initialData }: { initialData: ExecutionData }) {
  ...
  return (
    <div className="flex w-full h-full">
      <aside className="w-110 min-w-110 max-w-0 border-r-2 border-separate flex grow flex-col overflow-hidden">
...
function ParameterViewer({
  ...
  return (
    <Card>
      <CardHeader className="rounded-lg rounded-b-none py-4 bg-gray-50 dark:bg-background">
        ...
        <div className="flex flex-col gap-2">
          ...
          {params &&
            Object.entries(params).map(([key, value]) => (
              ...
              >
                <p className="text-sm text-muted-foreground flex-1 basis1/3">
                  {key}
                </p>
                <Input
                  readOnly
